...
export function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-4 md:px-8 bg-gradient-to-b from-white to-[var(--color-brand-accent)] dark:from-[var(--color-background)] dark:to-[var(--color-brand-dark)]/20 py-20">
      <motion.div
